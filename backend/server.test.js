...
describe('/signup and then delete', () => {
  test('/signup status code 201', async () => request(app)
    .post('/account/signup')
    .send({
...
describe('/signup and error', () => {
  ...
  test('/signup status code 500', async () => request(app)
    .post('/account/signup')
    .send({
      email: 'ddwang@seas.upenn.edu',
      firstName: 'David',
...
describe('/signup, /login, and then delete', () => {
  ...
  test('/login status code 200', async () => request(app)
    .post('/account/login')
    .send({
      email: 'ddwang@seas.upenn.edu',
      password: 'password',
...
describe('/login error', () => {
  ...
  test('/login status code 500', async () => request(app)
    .post('/account/login')
    .send({
      email: 'ddwang@seas.upenn.edu',
      password: 'passwordx',
...
describe('/user check', () => {
  ...
  test('/user status code 200 and delete', async () => request(app)
    .get('/account/user')
    .expect(200)
    .then(() => User.findOneAndDelete({ email: 'ddwang@seas.upenn.edu' })));
});
...
describe('/failedLogin check', () => {
  ...
  test('/failedLogin status code 200 and delete', async () => request(app)
...
describe('/resetpassword check', () => {
  ...
  test('/resetpassword status code 200 and delete', async () => request(app)
...
test('/getRegListings 200', async () => request(app).get('/item/getRegListings').expect(200));

test('/getBidListings 200', async () => request(app).get('/item/getBidListings').expect(200));

// END SELLER/HOMEPAGE TESTS

describe('/getRegListing/:id', () => {
  test('/buyer/getRegListing:id status code 200', async () => request(app)
    .get('/buyer/getRegListing/626630911a372e8bea7757ba')
    .expect(200));

  test('/buyer/getRegListing:id status code 500', async () => request(app)
...
describe('/getBidListing/:id', () => {
  test('/buyer/getBidListing:id status code 200', async () => request(app).get('/buyer/getBidListing/625381cd146ff361c085606f').expect(200));
  test('/buyer/getBidListing:id status code 500', async () => request(app)
...
describe('add and remove item to cart error', () => {
  ...
  test('/addCartRegItem/:id status code 500', async () => agent
    .post('/buyer/addCartRegItem/123456789')
    .expect(500)
    .then((resp) => expect(resp.text).toContain('Error adding item to cart')));

  test('/RemoveCartRegItem/:id status code 500', async () => agent
...
describe('add item to cart success', () => {
  ...
  test('/addCartRegItem/:id 200', async () => agent
  ...
  test('/cart status 200', async () => agent
    .get('/buyer/cart')
    .expect(200)
...
describe('remove item from cart success', () => {
  ...
  test('/removeCartRegItem/:id 200', async () => agent
...
describe('/buyer/cart error 500', () => {
  const agent = request.agent(app);
  test('/cart status 500', async () => agent
    .get('/buyer/cart')
    .expect(500)
...
describe('add and remove reg item to watchlist success', () => {
  ...
  test('/addWatchRegItem/:id 200', async () => agent
  ...
  test('/addWatchBidItem/:id 200', async () => agent
...
describe('add bid error', () => {
  const agent = request.agent(app);
  test('/addBid/:id status 500', async () => agent
...
describe('add bid success', () => {
  ...
  test('/addBid/:id status code 200', async () => agent
...
describe('regTransaction status code 500', () => {
  const agent = request.agent(app);
  test('/buyer/regTransaction status code 500', async () => agent
...
describe('regTransaction status code 201', () => {
  ...
  test('/item/addRegListing status code 201', async () => agent
    .post('/item/addRegListing')
    .send({
      product: 'productName',
  ...
  test('/logout 200', async () => agent.post('/account/logout').then((resp) => expect(resp.text).toContain('has been logged out!')));
  ...
  test('/buyer/regTransaction', async () => agent
    .post('/buyer/regTransaction')
    .send({
...
describe('addTransaction status code 200', () => {
  ...
  test('/buyer/addTransaction', async () => agent
    .post('/buyer/addTransaction')
    .send({
      transaction: {
        seller: 'David Wang',
...
describe('/search returns regular listing items', () => {
  ...
  test('/search result has correct regular listings', async () => agent
    .post('/item/search')
    .send({
      filter: 'productName',
      label: '',
...
describe('/bidSearch returns bid listing items', () => {
  ...
  test('/item/addBidListing status code 201', async () => agent
    .post('/item/addBidListing')
    .send({
      product: 'productName',
      productDescr: 'productDescr',
  ...
  test('/bidSearch result has correct bid listings', async () => agent
    .post('/item/bidSearch')
    .send({
      filter: 'productName',
      label: 'Clothes',
